...
// Removed illegal top-level return statements
    ...
    function renderGlobalPage1() {
        ...
        if (footer) {
            ...
            footer.innerHTML = `<button onclick="goToGlobalPage(-1, event)" style="flex:1;padding:10px;background:#17a2b8;color:white;border:none;cursor:pointer;margin:5px;">← ` + getTranslation('pagination.prev').split(' ')[1] + `</button><div style="flex:1;text-align:center;padding:10px;background:#f0f0f0;margin:5px;border-radius:4px;">` + getTranslation('modal.page') + ` 1/3</div><button onclick="goToGlobalPage(1, event)" style="flex:1;padding:10px;background:#1e3c72;color:white;border:none;cursor:pointer;margin:5px;">` + getTranslation('pagination.next').split(' ')[0] + ` →</button>`;
        }
    }
    ...
    function renderGlobalPage2() {
        ...
        if (footer) {
            footer.style.display = 'flex';
            footer.innerHTML = `<button onclick="goToGlobalPage(-1, event)" style="flex:1;padding:10px;background:#17a2b8;color:white;border:none;cursor:pointer;margin:5px;">← ` + getTranslation('pagination.prev').split(' ')[1] + `</button><div style="flex:1;text-align:center;padding:10px;background:#f0f0f0;margin:5px;border-radius:4px;">` + getTranslation('modal.page') + ` 2/3</div><button onclick="goToGlobalPage(1, event)" style="flex:1;padding:10px;background:#6db66d;color:white;border:none;cursor:pointer;margin:5px;">` + getTranslation('pagination.next').split(' ')[0] + ` →</button>`;
        }
    }
    ...
    function renderGlobalPage3() {
        ...
        if (footer) {
            footer.style.display = 'flex';
            footer.innerHTML = `<button onclick="goToGlobalPage(-1, event)" style="flex:1;padding:10px;background:#17a2b8;color:white;border:none;cursor:pointer;margin:5px;">← ` + getTranslation('pagination.prev').split(' ')[1] + `</button><div style="flex:1;text-align:center;padding:10px;background:#f0f0f0;margin:5px;border-radius:4px;">` + getTranslation('modal.page') + ` 3/3</div><button onclick="closeGlobalStatsModal()" style="flex:1;padding:10px;background:#6c757d;color:white;border:none;cursor:pointer;margin:5px;">` + getTranslation('modal.close') + ` ✕</button>`;
        }
    }
...
function displayChampions(data) {
    ...
    let nsHTML = `<div style="background:#eaf6fb;border-radius:8px;padding:12px 16px;margin-bottom:12px;">
        <div style="color:#1ca7c1;font-weight:bold;font-size:1.1em;">` + getTranslation('results.northSouth').replace('🧭 ', '') + `</div>`;
    ...
    let ewHTML = `<div style="background:#f0faea;border-radius:8px;padding:12px 16px;margin-bottom:12px;">
        <div style="color:#6db66d;font-weight:bold;font-size:1.1em;">` + getTranslation('results.eastWest').replace('🧭 ', '') + `</div>`;
...
function displayDirectionResults(data, direction) {
    ...
    html += `</div>`;
    if (filtered.length === 0) {
        html += `<div style='text-align:center;color:#999;font-size:1.1em;margin-top:24px;'>` + getTranslation('modal.noResults') + `</div>`;
    }
    if (resultsGrid) {
...
function openGlobalRangeModal(data, filterLabel) {
    ...
    prevBtn.textContent = getTranslation('pagination.prev');
    ...
    nextBtn.textContent = getTranslation('pagination.next');
    ...
    pageIndicator.textContent = getTranslation('modal.page') + ' 1/2';
...
function showGlobalRangeTab(tabNum) {
    ...
    if (tabNum === 1) {
        ...
        if (title) title.textContent = '📊 ' + getTranslation('rankings.statistics');
        ...
        html += '<div style="color:#d97706;font-weight:bold;font-size:0.95em;text-align:center;margin-bottom:12px;">🏆 ' + getTranslation('rankings.topChampions') + '</div>';
        ...
        html += '<div style="color:#16a34a;font-weight:bold;font-size:0.95em;text-align:center;margin-bottom:12px;">📈 ' + getTranslation('rankings.scoreAverageMin') + '</div>';
        ...
        // Satırlar
        if (sorted.length === 0) {
            html += '<div style="text-align:center;color:#999;padding:20px;">' + getTranslation('modal.noResults') + '</div>';
        } else {
            sorted.forEach(row => {
                const tarihParts = row['Tarih'].split('.');
                const tarihFormat = tarihParts[0] + '.' + tarihParts[1] + '.' + (tarihParts[2].length > 2 ? tarihParts[2].slice(-2) : tarihParts[2]);
...
function show2PageTab(tabNum) {
    ...
    if (tabNum === 1) {
        ...
        html += `<div style='color:#15803d;font-weight:bold;font-size:1.1em;margin-bottom:10px;text-align:center;'>📈 ` + getTranslation('rankings.scoreAverageMin') + `</div>`;
        ...
        html += `<button onclick='window.exportGlobalResults()' style='width:100%;padding:12px 15px;background:#39ff14;color:#000;border:none;border-radius:5px;cursor:pointer;font-weight:bold;font-size:0.95em;'>📥 ` + getTranslation('modal.exportExcel') + `</button>`;
        html += `</div>`;
...
function showDailyResultTab(tabNum) {
    ...
    if (tabNum === 1) {
        // Tab 1: Şampiyonlar
        if (header) header.textContent = '👑 ' + getTranslation('rankings.todayChampions');
        ...
        html += `<div style='color:#1ca7c1;font-weight:bold;font-size:0.9em;text-align:center;'>🗻 ` + getTranslation('results.northSouth').replace('🧭 ', '') + `</div>`;
        ...
        html += `<div style='color:#6db66d;font-weight:bold;font-size:0.9em;text-align:center;'>↔️ ` + getTranslation('results.eastWest').replace('🧭 ', '') + `</div>`;
        ...
        if (nsResults.length === 0) {
            html += `<div style='text-align:center;color:#999;'>` + getTranslation('modal.noResults') + `</div>`;
        } else {
            html += `<div style='display:flex;flex-direction:column;gap:8px;'>`;
        ...
        if (header) header.textContent = '↔️ ' + getTranslation('results.eastWestResults');
...
function showPlayerTab(tabNum) {
    ...
    if (tabNum === 1) {
        ...
        if (title) title.textContent = getTranslation('stats.title');
        ...
        html += '<div style="font-size:0.7em;opacity:0.9;margin-bottom:6px;text-align:center;">🎯 ' + getTranslation('stats.played') + '</div>';
        ...
        html += '<div style="font-size:0.7em;opacity:0.9;margin-bottom:6px;text-align:center;">🥇 ' + getTranslation('stats.firstPlace') + '</div>';
        ...
        html += '<div style="font-size:0.7em;opacity:0.9;margin-bottom:6px;text-align:center;">📊 ' + getTranslation('stats.avgScore') + '</div>';
        ...
        html += '<div style="font-size:0.7em;opacity:0.9;margin-bottom:6px;text-align:center;">👥 ' + getTranslation('stats.partners') + '</div>';
        ...
        html += '<div style="font-size:0.8em;color:#666;margin-bottom:8px;font-weight:bold;">🤝 ' + getTranslation('stats.mostPlayedPartner') + '</div>';
        ...
        html += '<div style="font-size:0.8em;color:#666;margin-bottom:8px;font-weight:bold;">⭐ ' + getTranslation('stats.bestScorePartner') + '</div>';
        ...
        if (title) {
            ...
            title.textContent = getTranslation('modal.tournamentsAndResults') + ' (' + recordCount + ' tur)';
        }
