#!/usr/bin/env python3
"""Simple sequential fetcher with detailed error reporting."""
...
try:
    ...
    # Get event page
    print("Step 1: Fetching event page...")
    ...
    print("Step 2: Fetching boards from pairs...")
