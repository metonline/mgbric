...
# Small sample bridge hands data generator
def generate_hands_data():
    """Generate test bridge hands data for 100 tournaments"""
    ...
    # Create hands for only first 100 tournaments
    for tournament in tournaments[:100]:
        try:
            ...
            hands_data["events"][event_key] = {
                ...
                "boards": generate_boards(5)  # Only 5 boards per tournament
            }
    ...
    file_size = len(json.dumps(hands_data)) / 1024 / 1024
...
if __name__ == '__main__':
    print("Generating smaller test hands data...")
    generate_hands_data()
    print("\nDone! Restart server and test at http://localhost:8000/app/www/")
